            ...
            <div class="pagination">
                <c:if test="${totalPages > 1}">
                    <c:if test="${currentPage > 0}">
                        <a href="?searchInput=${param.searchInput}&page=${currentPage - 1}">&laquo;</a>
                    </c:if>
                    <c:forEach begin="0" end="${totalPages - 1}" var="i">
                    <a href="?searchInput=${param.searchInput}&page=${i}">${i+1}</a>
                    </c:forEach>
                    <c:if test="${currentPage < totalPages - 1}">
                        <a href="?searchInput=${param.searchInput}&page=${currentPage + 1}">&raquo;</a>
                    </c:if>
                </c:if>
            </div>
        </div>
